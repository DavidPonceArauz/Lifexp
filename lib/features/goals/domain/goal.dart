...
class Goal {
  ...
  factory Goal.fromMap(Map<String, dynamic> map,
      {int objTotal = 0, int objCompleted = 0}) =>
      Goal(
        id:           map['id'] as int,
...
class Objective {
  ...
  final int goalId;
  final String title;
  final String description; // ← nuevo campo (rich JSON o texto plano)
  final String? deadline;
  final String status;
  final String type;
  final int? habitId;
  ...
  Objective copyWith({String? status, String? description}) => Objective(
    id:          id,
    goalId:      goalId,
    title:       title,
    description: description ?? this.description,
